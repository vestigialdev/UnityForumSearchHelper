...
function SelectSubforum(){
	...
	if(!urlParams.has('forumId')){
		...
		console.warn("UnityForumSearchHelper: Couldn't find 'forumId' in query string. It should have been passed by previously clicking on the Search button in the forum");
		return false;
	}
